...
editables.addEventListener("blur", () => {
    if (editables.innerHTML == "") {
        alert("Por favor ingrese un nombre valido para el tablero");
    }
...
for (var key in localStorage) {
    if (key.includes("dataStorage-title")) {
        ...
        if (localStorage.getItem(key) != "") {
            ...
            document.getElementById(id).innerHTML = "Tu tablero";
...
function modalpop(modalId) {
    ...
    if (taskDetails[modalId]) {
        ...
        document.getElementById("modal-text").innerText = "Algo fallo!";
